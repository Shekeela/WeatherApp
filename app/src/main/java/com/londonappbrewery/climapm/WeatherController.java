...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "dd90e84586d3d3b904a09ff6d80c4c60";
    ...
    private void getWeatheForCurrentLocation()
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
...

        {
            if(grantResults.length>0 &&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                Log.d("Clima","OnRequestPermisionResult: Permission Granted");
                getWeatheForCurrentLocation();
            }else
            {
    ...
    private void letsDoSomeNetworking(RequestParams params){
        ...
        client.get(WEATHER_URL,params,new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] header, JSONObject response ){
                ...
                Log.d("Clima","Sucess"+ response.toString());
            ...
            public void onFailure(int statuscode, Header[] header,Throwable e,JSONObject response) {
                ...
                Log.d("Clima", "StsuutusCode: "+statuscode);
